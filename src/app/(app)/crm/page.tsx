...
export default async function CrmPage() {
  ...
  let resumen: Awaited<ReturnType<typeof getResumenBase>> = undefined as any;
  ...
  try {
    ...
    // Consideramos que hay datos si existe la tabla ventas con filas
    dataAvailable = (resumen?.total_filas ?? 0) > 0;
  } catch {
    dataAvailable = false;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Banner datos pendientes — mostrado cuando no hay datos */}
      {!dataAvailable && (
        <div
      ...
      {/* Contenido completo — solo si hay datos */}
      {dataAvailable && (
        <>
